...
export const BrochureScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','url','title','approved','propertyId','inpaintedRectangles','textToRemove','pathsToRemove','undoStack','deletedPages']);
