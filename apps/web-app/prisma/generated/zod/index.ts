...
export const AgentScalarFieldEnumSchema = z.enum(['id','customerAgentId','createdAt','updatedAt','ownerId','name','phoneNumber','githubRepoUrl','systemPrompt','enableSlackNotifications']);
