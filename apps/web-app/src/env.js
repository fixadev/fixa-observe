...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SELF_HOSTED_ORGANIZATION_ID: z.string(),
    NEXT_PUBLIC_SELF_HOSTED_USER_ID: z.string(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SELF_HOSTED_ORGANIZATION_ID:
      process.env.NEXT_PUBLIC_SELF_HOSTED_ORGANIZATION_ID,
    NEXT_PUBLIC_SELF_HOSTED_USER_ID:
      process.env.NEXT_PUBLIC_SELF_HOSTED_USER_ID,
