          ...
          <div className="flex flex-row items-center gap-4 rounded-md bg-gray-100 p-2">
            <Select
              ...
              onValueChange={(value) => {
                onUpdate({
                  ...alert,
                  details: { ...alert.details, percentile: value },
                });
              }}
            >
            ...
            <div>{">="}</div>
            <Select
              value={alert.details?.threshold}
              onValueChange={(value) => {
                onUpdate({
                  ...alert,
                  details: { ...alert.details, threshold: value },
                });
              }}
            >
              <SelectTrigger className="w-fit bg-white">
        ...
        <div>
          ...
          <div className="flex flex-row items-center gap-4">
            ...
            <Input
              ...
              value={taggedNames[taggedNames.length - 1]}
              onChange={(e) => setTaggedNames([...taggedNames, e.target.value])}
            />
          </div>
        </div>
      </CardContent>
