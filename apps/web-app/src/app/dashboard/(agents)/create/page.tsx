...
export default function CreateAgentPage() {
  ...
  const { mutate: createAgent, isPending: isCreatingAgent } =
    api.agent.create.useMutation({
      onSuccess: (data) => {
        void router.push(`/dashboard/${data.id}`);
      },
    });
  ...
  return (
    <div className="flex h-[95vh] w-[95vw] min-w-[95vw] flex-col p-0 px-4">
      <h1 className="p-6 pb-2 text-2xl font-medium">new agent</h1>
