export default function PrivacyPage() {
  return (
    <div className="prose mx-auto p-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Pixa, Inc., 1395 22nd St Apt 857, San
            Francisco, CA, 94104.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to fixa, accessible from{" "}
            <a
              href="https://fixa.dev"
      ...
      <ul>
        <li>
          <p>By email: contact@fixa.dev</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://fixa.dev/privacy"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://fixa.dev/privacy
            </a>
          </p>
        </li>
      </ul>
