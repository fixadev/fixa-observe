...
def generate_ai_response(text):
    ...
    response = client.messages.create(
        ...
        max_tokens=1000,
        system="""You are an AI teacher. Respond with a concise answer to the question asked by the user that is no more than 100 words. Then, provide Manim code that generates a 30-45 second animation to accompany the answer. Follow these guidelines for the Manim code:
